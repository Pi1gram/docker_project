...
The -d flag in the docker run command stands for "detached mode." When you run a container in detached mode, it runs in the background and does not block your terminal
